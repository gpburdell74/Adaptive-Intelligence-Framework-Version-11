...
namespace Adaptive.Intelligence.Framework.Tests.Abstractions
{
    ...
    public class SimpleLogBaseTests
    {
        ...
        [Fact]
        /// <summary>
        /// Gets the definition for Can_Create_And_Log_To_Default.
        /// </summary>
        ...
        [Fact]
        /// <summary>
        /// Gets the definition for Default_File_Name_Present.
        /// </summary>
        ...
        [Fact]
        /// <summary>
        /// Gets the definition for Specified_File_Name_Present.
        /// </summary>
        ...
        [Fact]
        /// <summary>
        /// Gets the definition for Can_Log_Exception.
        /// </summary>
        public void Can_Log_Exception()
        {
            ...
            int index = text.IndexOf("Exception: ['This is for a test.']", StringComparison.Ordinal);
            Assert.True(index > 0);

            Assert.Contains("Exception: ['This is for a test.']", text, StringComparison.Ordinal);
        ...
        [Fact]
        /// <summary>
        /// Gets the definition for Log_Null_Does_Not_Write_Log_Content.
        /// </summary>
        ...
        [Fact]
        /// <summary>
        /// Gets the definition for Suspend_Prevents_Writes.
        /// </summary>
        ...
        [Fact]
        /// <summary>
        /// Gets the definition for Resume_Reenables_Writes_After_Suspend.
        /// </summary>
        ...
        [Fact]
        /// <summary>
        /// Gets the definition for LogException_With_Context_Writes_Context_And_Exception.
        /// </summary>
        ...
        [Fact]
        /// <summary>
        /// Gets the definition for Dispose_With_External_Stream_Does_Not_Close_Parent_Stream.
        /// </summary>
        ...
        [Fact]
        /// <summary>
        /// Gets the definition for Constructor_With_Existing_File_Uses_Unique_File_Name.
        /// </summary>
        ...
        [Fact]
        /// <summary>
        /// Gets the definition for Log_Raises_LoggerException_When_Write_Fails.
        /// </summary>
