...
namespace Adaptive.Intelligence.Abstractions
{
    ...
    public class AdaptiveCollectionBase<T> : List<T>, INotifyCollectionChanged
    {
        ...
        /// </param>
        public new virtual void Add(T instance)
        {
            base.Add(instance);
        ...
        /// </param>
        public new virtual void Remove(T instance)
        {
            if (instance != null && Contains(instance))
            {
                _ = base.Remove(instance);
                OnCollectionChanged(NotifyCollectionChangedAction.Remove);
            }
        }
        ...
        /// </param>
        public new virtual void RemoveAll(Predicate<T> matchingFunction)
        {
            _ = base.RemoveAll(matchingFunction);
            OnCollectionChanged(NotifyCollectionChangedAction.Remove);
        }
        /// <summary>
        ...
        /// </param>
        public new virtual void Sort(Comparison<T> comparisonFunction)
        {
