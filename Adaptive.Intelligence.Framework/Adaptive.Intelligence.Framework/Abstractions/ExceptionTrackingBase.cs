...
namespace Adaptive.Intelligence.Abstractions
{
    ...
    public abstract class ExceptionTrackingBase : DisposableObjectBase, IExceptionTracking
    {
        ...
        /// </value>
        public Exception? FirstException => _exceptionList == null || _exceptionList.Count == 0 ? null : _exceptionList[0];
        ...
        /// </summary>
        /// <param name="result">
        /// The <see cref="IOperationResult"/> result from a SQL operation.
        /// </param>
        public void CopyExceptions(IOperationResult? result)
        {
            if (!IsDisposed)
            {
